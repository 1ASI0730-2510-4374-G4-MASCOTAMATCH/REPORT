...
| HU02  | Botón See Services                   | Como visitante, quiero acceder a la sección de servicios con el botón “See Services” | Escenario 1: El botón funciona correctamente desde la portada. <br> **Given** estoy en la portada, **When** hago click en el botón "See Services", **Then** la página hace un scroll automático a la sección "Servicios"         |
