...
|---------------|----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
| HU19          | Inicio de Sesión con validación | Como desarrollador, quiero que los usuarios ingresen su correo y contraseña y reciban una validación inmediata, para evitar campos vacíos o datos incorrectos.   | Escenario 1: El usuario deja campos vacíos y el sistema muestra una alerta “Por favor ingrese su correo y contraseña.”<br>Escenario 2: El usuario completa los campos correctamente, hace clic en "Iniciar Sesión" y accede al sistema.                                                               | EPIC05                  |
| HU20          | Visualizar planes disponibles    | Como desarrollador, quiero mostrar los distintos planes (Mini,Complete,vip) con nombre, descripción y botón “Comprar”, para facilitar elección.  | Escenario 1: El usuario accede y ve los tres planes diferenciados visualmente.<br>Escenario 2: Al hacer clic en “Comprar”, se registra la elección del plan.                                                                                                                                            | EPIC02                  |
| HU21          | Gestión de mascotas              | Como desarrollador, quiero permitir que el usuario vea, agregue, elimine y seleccione mascotas en tarjetas, para que gestione fácilmente su información.          | Escenario 1: Se muestran las tarjetas con nombre y edad de cada mascota.<br>Escenario 2: El usuario puede hacer clic en “Eliminar” para borrarla o en “Seleccionar” para elegirla.                                                                                                                     | EPIC04                  |
| HU22          | Agregar nueva mascota            | Como desarrollador, quiero que el usuario pueda ingresar nombre y edad en un formulario sencillo, para registrar fácilmente a su mascota.                        | Escenario 1: El usuario accede al formulario desde el menú “Agregar Mascota”.<br>Escenario 2: Al hacer clic en “Guardar”, la nueva mascota se añade a las tarjetas visibles.                                                                                                                           | EPIC04                  |
| HU23          | Compra de medicamentos           | Como desarrollador, quiero mostrar medicamentos con nombre, descripción, selector de cantidad y botón “Comprar”, para que el usuario adquiera lo necesario.       | Escenario 1: El usuario accede a la pestaña “Medicamentos” y ve vacunas, desparasitantes y antibióticos.<br>Escenario 2: Puede seleccionar la cantidad con flechas y hacer clic en “Comprar” para agregarlos a su historial.                                                                        | EPIC01                  |
| HU24          | Validación de campos vacíos en compra | Como desarrollador, quiero validar que el usuario seleccione al menos una unidad de medicamento antes de hacer clic en “Comprar”, para evitar errores de compra. | Escenario 1: Si no hay unidades seleccionadas, el sistema muestra un mensaje de error.<br>Escenario 2: Al seleccionar una cantidad y hacer clic en “Comprar”, se guarda correctamente el producto.                                                                                                  | EPIC01                  |
| HU25          | Historial de tratamientos        | Como desarrollador, quiero mostrar en una tabla el historial de productos aplicados a cada mascota, para que el usuario tenga trazabilidad de los tratamientos.   | Escenario 1: El usuario accede al historial y ve una tabla con columnas: ID, Nombre (usuario), Mascota, Producto, Descripción.<br>Escenario 2: Se cargan todos los registros anteriores en orden cronológico.                                                                                         | EPIC04                  |
| HU26          |  Mostrar historial  | Como desarrollador, quiero permitir filtrar el historial por mascota, para que el usuario visualice solo los registros relevantes.                               | Escenario 1: El usuario selecciona una mascota de una lista desplegable y ve solo sus tratamientos.<br>Escenario 2: Al quitar el filtro, se muestra nuevamente todo el historial completo.                                                                                                           | EPIC04                  |
