...
|:----------------|:-------|:------------|:------------------------|:-----------------------|
| EPIC01 | Landing Page: Portada y Servicios | **Como** visitante,<br>**Quiero** entender rápidamente los servicios ofrecidos del sitio web,<br>**Para** decidir si explorar más. |  | - |
| EPIC02 | Planes de Suscripción | **Como** usuario,<br>**Quiero** comparar los distintos planes de servicio,<br>**Para** elegir el más adecuado para las necesidades de mi mascota. |  | - |
| EPIC03 | Sección de Preguntas Frecuentes (FAQ) | **Como** usuario, <br>**Quiero** acceder fácilmente a preguntas frecuentes organizadas y claras,<br>**Para** resolver mis dudas rápidamente sin necesidad de asistencia adicional. |  | - |
| EPIC04 | Navegación y estructura general | **Como** visitante,<br>**Quiero** navegar de manera intuitiva entre secciones, <br>**Para** encontrar fácilmente lo que busco. |  | - |
| EPIC05 | Registro y Login | **Como** usuario, <br>**Quiero** poder registrarme y acceder mediante logeo de manera sencilla,<br>**Para** proteger el acceso a la landing page y personalizar mi experiencia. |  | - |
| EPIC06 | Diseño Visual y Responsividad | **Como** usuario,<br>**Quiero** que el sitio se adapte visualmente a computadoras, tablets y celulares,<br>**Para** tener una experiencia agradable y cómoda desde cualquier lugar. |  | - |

| ID    | Título                               | Descripción                                                                                         | Criterios de Aceptación                                                                                                                                                                                                                                       | Epic Relacionado |
|-------|--------------------------------------|-----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| HU01  | Mensaje de bienvenida visible        | Como visitante, quiero ver un mensaje de bienvenida que me explique qué es MascotaMatch.            | Escenario 1: Se muestra un mensaje con la descripción del sitio. <br> **Given** accedo a la página, **When** se carga el contenido, **Then** veo el título "MascotaMatch" y un mensaje de bienvenida. <br> Escenario 2: No se muestra la pantalla principal. <br> **Given** el servidor no responde, **When** la página carga, **Then** se muestra solo un texto genérico sin formatos.                                                                                                            | EPIC01           |
| HU02  | Botón See Services                   | Como visitante del segmento Dueño de mascota, quiero acceder a la sección de servicios con el botón “See Services” | Escenario 1: El botón funciona correctamente desde la portada. <br> **Given** estoy en la portada, **When** hago click en el botón "See Services", **Then** la página hace un scroll automático a la sección "Servicios"         |EPIC01           |
| HU03  | Información de servicios           | Como visitante, quiero ver tarjetas de servicios con iconos, nombre y descripción. Para poder comprender con facilidad             | Escenario 1: Se muestran 4 tarjetas de servicios (paseos, grooming, emergencias, recordatorios). <br> **Given** ingreso a la sección de Services, **When** se carga la página, **Then** visualizo las 4 tarjetas con información clara.                                                                               | EPIC01           |
| HU04  | Acceso a sección FAQ                 | Como visitante, quiero ver una sección con preguntas frecuentes organizadas para resolver dudas.     | Escenario 1: Se muestran al menos 6 preguntas. <br> **Given** accedo a la sección de FAQ, **When** se carga la página, **Then** visualizo al menos 6 preguntas frecuentes.                                                                                                                                            | EPIC03           |
...
| HU06  | Menú de navegación                   | Como visitante, quiero tener acceso a un menú con Home, Services, Plans y FAQ.                       | Escenario 1: El menú aparece como barra superior. <br> **Given** estoy en la página principal, **When** observo la interfaz, **Then** veo un menú con las opciones a seleccionar sección de Home, Services, Plans y FAQ.                                                                                                              | EPIC04           |
| HU07  | Footer con contacto y redes          | Como visitante, quiero ver un footer con contacto y enlaces útiles.                                 | Escenario 1: Aparece en la parte inferior. <br> **Given** estoy en la página, *Cuando** me desplazo hacia abajo, Entonces veo el footer en la parte inferior.                                                                                                                                                     | EPIC04           |
| HU08  | Pantalla de login obligatoria        | Como usuario del segmento objetivo Dueño de mascota/Proveedor de cuidado animal, quiero iniciar sesión para acceder a la landing.                                     | Escenario 1: Inicio de sesión exitoso <br> **Dado** que me registré como Dueño de mascota/Proveedor de cuidado animal, **When** ingreso mi correo y contraseña, **Then** debería acceder a la landing <br> Escenario 2: Inicio de sesión fallido **Given** que soy un médico/paciente registrado, **When** ingreso mi correo y contraseña incorrecto, **Then** se muestra un error donde te pide logearte nuevamente con las credenciales correctas                                                                                                                                        | EPIC05           |
| HU09  | Registro de usuarios                 | Como usuario del segmento objetivo Dueño de mascota/Proveedor de cuidado animal, quiero registrarme para acceder a la plataforma.                               | Escenario 1: Desde login se puede ir a registro. <br> **Given** estoy en la pantalla de login, **When** no me he registrado antes , **Then** veo un enlace para registrarme y accedo. <br> Escenario 2: Se ingresan las credenciales inválidas. <br> **Given** que quiero registrarme **When** ya me he registrado anteriormente, **Then** se le niega la operación                                                                                                                                                | EPIC05           |
| HU10  | Diseño visual uniforme               | Como visitante, quiero que la web tenga un diseño consistente.                                       | Escenario 1: Se usa una paleta de colores uniforme. <br> **Given** navego por el sitio, **When** observo los elementos visuales,**Then** noto que se utiliza una paleta de colores coherente.                                                                                                                                         | EPIC06           |
| HU11  | Visualización responsiva             | Como visitante, quiero ver bien el contenido desde PC y celular.                                     | Escenario 1: Se adapta el diseño en móviles. <br> **Given** estoy usando un dispositivo móvil, **When** accedo al sitio, **Then** el diseño se adapta correctamente.                                                                                                                                                    | EPIC06           |
| HU12  | Acceso a detalle de plan             | Como visitante, quiero ver más información del plan haciendo clic en “Read More”.                    | Escenario 1: Se redirige a una página por plan. <br> **Given** estoy en la página de planes, **When** hago clic en "Read More" de un plan, **Then** soy redirigido a una página con más detalles de ese plan.                                                                                                                                                 | EPIC02           |
| HU13  | Visualización de planes de suscripción | Como visitante, quiero ver los tres planes (Mini, Completo, VIP) para comparar.                     | Escenario 1: Cada plan tiene imagen, lista de beneficios y botón “Read More”. <br> **Given** estoy en la página de planes, **When** observo cada plan, **Then** veo una imagen, una lista de beneficios y un botón "Read More".                                                                                                                         | EPIC02           |
| HU14  | Botón “See Plans” funcional          | Como visitante, quiero hacer clic en “See Plans” para ir directamente a los planes.                  | Escenario 1: El botón redirige correctamente. <br> **Given** estoy en la página principal, **When** hago clic en "See Plans", **Then** soy redirigido a la sección de planes.                                                                                                                                                    | EPIC02           |
| HU15  | Transiciones visuales animadas       | Como visitante, quiero que los elementos aparezcan con animación suave.                              | Escenario 1: El contenido entra con transición. <br> **Given** accedo a una sección, **When** se carga el contenido, **Then** los elementos aparecen con una animación suave.                                                                                                                                              | EPIC06           |
| HU16  | Efectos hover en botones             | Como visitante, quiero ver cambios visuales al pasar el cursor sobre los botones.                    | Escenario 1: Al pasar el mouse cambia color o sombra. <br> **Given** estoy navegando por el sitio, **When** paso el cursor sobre un botón, **Then** el botón cambia de color o muestra una sombra.                                                                                                                                               | EPIC06           |
| HU17  | Método de pago                       | Como usuario, quiero elegir método de pago (Yape, tarjeta, PayPal) desde la vista de planes.         | Escenario 1: Desde un botón en la tarjeta accedo al pago. <br> **Given** estoy en la página de planes, **When** selecciono "Pagar", **Then** puedo elegir entre Yape, tarjeta o PayPal y confirmar el pago.                                                                                                                              | EPIC02           |
| HU18  | Agendar cita desde servicios         | Como usuario, quiero agendar una cita desde la tarjeta de servicio.                                  | Escenario 1: Cada tarjeta tiene botón “Agendar”. <br> **Given** estoy viendo un servicio, **When** hago clic en "Agendar", **Then** se abre un formulario con fecha, proveedor y tipo de atención.                                                                                                                          | EPIC01           |
| User Story ID | Título                          | Descripción                                                                                                                                                       | Criterios de Aceptación                                                                                                                                                                                                                                                                               | Relacionado con (Epic) |
|---------------|----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
| HU19          | Inicio de Sesión con validación | Como desarrollador, quiero que los usuarios ingresen su correo y contraseña y reciban una validación inmediata, para evitar campos vacíos o datos incorrectos.   | Escenario 1: El usuario deja campos vacíos y el sistema muestra una alerta “Por favor ingrese su correo y contraseña.”<br>**Given** completo el formulario de cita, **When** hago clic en "Confirmar", **Then** recibo una notificación visual de éxito. <br>                                                               | EPIC05                  |
| HU20          | Visualizar planes disponibles    | Como desarrollador, quiero mostrar los distintos planes (Mini,Complete,vip) con nombre, descripción y botón “Comprar”, para facilitar elección.  | Escenario 1: El usuario accede y ve los tres planes diferenciados visualmente.<br>Escenario 2: Al hacer clic en “Comprar”, se registra la elección del plan. <br> **Given** dejo campos obligatorios vacíos, **When** intento enviar, **Then** se muestra un mensaje de error en los campos correspondientes.                                                                                                                                         | EPIC02                  |
| HU21          | Gestión de mascotas              | Como desarrollador, quiero permitir que el usuario vea, agregue, elimine y seleccione mascotas en tarjetas, para que gestione fácilmente su información.          | Escenario 1: Se muestran las tarjetas con nombre y edad de cada mascota.<br> **Given** no recuerdo mi contraseña, **When** uso la opción “Olvidé mi contraseña”, **Then** recibo instrucciones por correo.                                                                                                                   | EPIC04                  |
| HU22          | Agregar nueva mascota            | Como desarrollador, quiero que el usuario pueda ingresar nombre y edad en un formulario sencillo, para registrar fácilmente a su mascota.                        | Escenario 1: El usuario accede al formulario desde el menú “Agregar Mascota”.<br> **Given** tengo una cita agendada, **When** hago clic en “Cancelar”, **Then** se elimina la cita y se muestra un mensaje de confirmación.                                                                                                                          | EPIC04                  |
| HU23          | Compra de medicamentos           | Como desarrollador, quiero mostrar medicamentos con nombre, descripción, selector de cantidad y botón “Comprar”, para que el usuario adquiera lo necesario.       | Escenario 1: El usuario accede a la pestaña “Medicamentos” y ve vacunas, desparasitantes y antibióticos.<br>**Given** accedo a mi perfil, **When** hago clic en “Historial”, **Then** veo una lista cronológica de mis servicios anteriores.                                                                       | EPIC01                  |
| HU24          | Validación de campos vacíos en compra | Como desarrollador, quiero validar que el usuario seleccione al menos una unidad de medicamento antes de hacer clic en “Comprar”, para evitar errores de compra. | Escenario 1: Si no hay unidades seleccionadas, el sistema muestra un mensaje de error.<br> **Given** estoy en mi perfil, **When** hago clic en “Editar”, **Then** puedo actualizar mis datos y guardar los cambios correctamente.	.                                                                                                  | EPIC01                  |
| HU25          | Historial de tratamientos        | Como desarrollador, quiero mostrar en una tabla el historial de productos aplicados a cada mascota, para que el usuario tenga trazabilidad de los tratamientos.   | Escenario 1: El usuario accede al historial y ve una tabla con columnas: ID, Nombre (usuario), Mascota, Producto, Descripción.<br> **Given** estoy autenticado, **When** hago clic en “Cerrar sesión”, **Then** mi sesión se cierra y soy redirigido al login.                                                                                        | EPIC04                  |
| HU26          |  Mostrar historial  | Como desarrollador, quiero permitir filtrar el historial por mascota, para que el usuario visualice solo los registros relevantes.                               | Escenario 1: El usuario selecciona una mascota de una lista desplegable y ve solo sus tratamientos.<br>**Given** he iniciado sesión correctamente, **When** veo la barra de navegación, **Then** se muestra mi nombre en la esquina superior derecha.                                                                                                           | EPIC04                  |
