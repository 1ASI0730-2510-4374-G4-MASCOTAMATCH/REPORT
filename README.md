...
|-------|--------------------------------------|-----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| HU01 | Registro de usuarios | Como usuario del segmento objetivo Dueño de mascota/Proveedor de cuidado animal, quiero registrarme para acceder a la plataforma. | Escenario 1: Desde login se puede ir a registro. <br> **Dado** estoy en la pantalla de login, **Cuando** no me he registrado antes , **Entonces** veo un enlace para registrarme y accedo. <br> Escenario 2: Se ingresan las credenciales inválidas. <br> **Dado** que quiero registrarme **Cuando** ya me he registrado anteriormente, **Entonces** se le niega la operación | EPIC01 |
| HU02 | Inicio de sesión | Como usuario del segmento objetivo Dueño de mascota/Proveedor de cuidado animal, quiero iniciar sesión para acceder a la landing. | Escenario 1: Inicio de sesión exitoso <br> **Dado** que me registré como Dueño de mascota/Proveedor de cuidado animal, **Cuando** ingreso mi correo y contraseña, **Entonces** debería acceder a la landing <br> Escenario 2: Inicio de sesión fallido **Dado** que soy un médico/paciente registrado, **Cuando** ingreso mi correo y contraseña incorrecto, **Entonces** se muestra un error donde te pide logearte nuevamente con las credenciales correctas | EPIC01 |
| HU03 | Elección y visualización de plan actual | Como dueño de mascota, quiero elegir un plan para que se visualice que plan actual tengo| Escenario 1: Ver la elección del plan actual **Dado** ingreso a la sección de planes y visualizo la información, **Cuando** elijo uno de los planes disponibles, **Entonces** debe mostrarse que plan actual se ha elegido. | EPIC02 |
| HU04 | Compra de planes disponibles | Como dueño de mascota, quiero ver los planes disponibles y sus beneficios para elegir el de preferencia propia   | Escenario 1: Se muestran los distintos planes disponibles. **Dado** ingreso a la sección de planes, **Cuando** visualizo los planes disponibles con sus respectivos beneficios y precios, **Entonces** elijo uno y le doy al botón “Comprar”. | EPIC02 |
| HU05 | Selección de método de pago | Como dueño de mascota, quiero elegir método de pago (Yape, tarjeta, PayPal) desde la vista de planes. | Escenario 1: Desde un botón en la tarjeta accedo al pago. <br> **Dado** que estoy en la página de planes o en citas, **Cuando** quiero acceder a un pago, le doy al botón "Comprar", **Entonces** puedo elegir métodos como Yape, tarjeta o PayPal y confirmar el pago. | EPIC02 |
| HU06 | Historial de pagos |Como dueño de mascota, quiero consultar un historial de pagos anteriores, para tener registro de mis transacciones realizadas. | Escenario 1: Luego de acceder a un pago se registra debajo un apartado del historial de pagos <br> **Dado** que he pagado una cita o plan, **Cuando** visualizo que debajo se registra el pago en un historial **Entonces** puedo verificar los datos del pago desde esa boleta. | EPIC02 |
...
| HU09 | Comprar medicina | Como dueño de mascota, quiero comprar medicinas para el cuidado de mi mascota | Escenario 1: Quiero comprar medicina para mi mascota. <br> **Dado** dado estoy viendo las medicinas, **Cuando** agrego la cantidad que necesito **Entonces** se registra la compra en el historial | EPIC04 |
