...
|-------|--------------------------------------|-----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| HU01  | Mensaje de bienvenida visible        | Como visitante, quiero ver un mensaje de bienvenida que me explique qué es MascotaMatch.            | Escenario 1: Se muestra un mensaje con la descripción del sitio. <br> **Dado que** accedo a la página, **Cuando** se carga el contenido, **Entonces** veo el título "MascotaMatch" y un mensaje de bienvenida. <br> Escenario 2: No se muestra la pantalla principal. <br> **Dado que** el servidor no responde, **Cuando** la página carga, **Entonces** se muestra solo un texto genérico sin formatos.                                                                                                            | EPIC01           |
| HU02  | Botón See Services                   | Como visitante, quiero acceder a la sección de servicios con el botón “See Services” | Escenario 1: El botón funciona correctamente desde la portada. <br> **Dado que** estoy en la portada, **Cuando** hago click en el botón "See Services", **Entonces** la página hace un scroll automático a la sección "Servicios"         |
| HU03  | Información de servicios           | Como visitante, quiero ver tarjetas de servicios con iconos, nombre y descripción. Para poder comprender con facilidad             | Escenario 1: Se muestran 4 tarjetas de servicios (paseos, grooming, emergencias, recordatorios). <br> **Dado que** ingreso a la sección de Services, **Cuando** se carga la página, **Entonces** visualizo las 4 tarjetas con información clara.                                                                               | EPIC01           |
| HU04  | Acceso a sección FAQ                 | Como visitante, quiero ver una sección con preguntas frecuentes organizadas para resolver dudas.     | Escenario 1: Se muestran al menos 6 preguntas. <br> **Dado que** accedo a la sección de FAQ, **Cuando** se carga la página, **Entonces** visualizo al menos 6 preguntas frecuentes.                                                                                                                                            | EPIC03           |
...
| HU06  | Menú de navegación                   | Como visitante, quiero tener acceso a un menú con Home, Services, Plans y FAQ.                       | Escenario 1: El menú aparece como barra superior. <br> **Dado que** estoy en la página principal, **Cuando** observo la interfaz, **Entonces** veo un menú con las opciones a seleccionar sección de Home, Services, Plans y FAQ.                                                                                                              | EPIC04           |
| HU07  | Footer con contacto y redes          | Como visitante, quiero ver un footer con contacto y enlaces útiles.                                 | Escenario 1: Aparece en la parte inferior. <br> **Dado que** estoy en la página, *Cuando** me desplazo hacia abajo, Entonces veo el footer en la parte inferior.                                                                                                                                                     | EPIC04           |
| HU08  | Pantalla de login obligatoria        | Como visitante, quiero iniciar sesión para acceder a la landing.                                     | Escenario 1: Inicio de sesión exitoso <br> **Dado que no he iniciado sesión**, **Cuando** intento acceder a la landing, **Entonces** soy redirigido obligatoriamente al login donde debo colocar mi correo y contraseña <br> Escenario 2: Inicio de sesión fallido **Dado que** el servidor falla, **Cuando** intento acceder, **Entonces** Se muestra un error de logeo y se debe volver a intentar más tarde                                                                                                                                         | EPIC05           |
| HU09  | Registro de usuarios                 | Como nuevo visitante, quiero registrarme para acceder a la plataforma.                               | Escenario 1: Desde login se puede ir a registro. <br> **Dado que** estoy en la pantalla de login, **Cuando** no me he registrado antes , **Entonces** veo un enlace para registrarme y accedo.                                                                                                                                              | EPIC05           |
| HU10  | Diseño visual uniforme               | Como visitante, quiero que la web tenga un diseño consistente.                                       | Escenario 1: Se usa una paleta de colores uniforme. <br> **Dado que** navego por el sitio, **Cuando** observo los elementos visuales,**Entonces** noto que se utiliza una paleta de colores coherente.                                                                                                                                         | EPIC06           |
| HU11  | Visualización responsiva             | Como visitante, quiero ver bien el contenido desde PC y celular.                                     | Escenario 1: Se adapta el diseño en móviles. <br> **Dado que** estoy usando un dispositivo móvil, **Cuando** accedo al sitio, **Entonces** el diseño se adapta correctamente.                                                                                                                                                    | EPIC06           |
| HU12  | Acceso a detalle de plan             | Como visitante, quiero ver más información del plan haciendo clic en “Read More”.                    | Escenario 1: Se redirige a una página por plan. <br> **Dado que** estoy en la página de planes, **Cuando** hago clic en "Read More" de un plan, **Entonces** soy redirigido a una página con más detalles de ese plan.                                                                                                                                                 | EPIC02           |
| HU13  | Visualización de planes de suscripción | Como visitante, quiero ver los tres planes (Mini, Completo, VIP) para comparar.                     | Escenario 1: Cada plan tiene imagen, lista de beneficios y botón “Read More”. <br> **Dado que** estoy en la página de planes, **Cuando** observo cada plan, **Entonces** veo una imagen, una lista de beneficios y un botón "Read More".                                                                                                                         | EPIC02           |
| HU14  | Botón “See Plans” funcional          | Como visitante, quiero hacer clic en “See Plans” para ir directamente a los planes.                  | Escenario 1: El botón redirige correctamente. <br> **Dado que** estoy en la página principal, **Cuando** hago clic en "See Plans", **Entonces** soy redirigido a la sección de planes.                                                                                                                                                    | EPIC02           |
| HU15  | Transiciones visuales animadas       | Como visitante, quiero que los elementos aparezcan con animación suave.                              | Escenario 1: El contenido entra con transición. <br> **Dado que** accedo a una sección, **Cuando** se carga el contenido, **Entonces** los elementos aparecen con una animación suave.                                                                                                                                              | EPIC06           |
| HU16  | Efectos hover en botones             | Como visitante, quiero ver cambios visuales al pasar el cursor sobre los botones.                    | Escenario 1: Al pasar el mouse cambia color o sombra. <br> **Dado que** estoy navegando por el sitio, **Cuando** paso el cursor sobre un botón, **Entonces** el botón cambia de color o muestra una sombra.                                                                                                                                               | EPIC06           |
| HU17  | Método de pago                       | Como usuario, quiero elegir método de pago (Yape, tarjeta, PayPal) desde la vista de planes.         | Escenario 1: Desde un botón en la tarjeta accedo al pago. <br> **Dado que** estoy en la página de planes, **Cuando** selecciono "Pagar", **Entonces** puedo elegir entre Yape, tarjeta o PayPal y confirmar el pago.                                                                                                                              | EPIC02           |
| HU18  | Agendar cita desde servicios         | Como usuario, quiero agendar una cita desde la tarjeta de servicio.                                  | Escenario 1: Cada tarjeta tiene botón “Agendar”. <br> **Dado que** estoy viendo un servicio, **Cuando** hago clic en "Agendar", **Entonces** se abre un formulario con fecha, proveedor y tipo de atención.                                                                                                                          | EPIC01           |
| User Story ID | Título                          | Descripción                                                                                                                                                       | Criterios de Aceptación                                                                                                                                                                                                                                                                               | Relacionado con (Epic) |
|---------------|----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
| HU19          | Inicio de Sesión con validación | Como desarrollador, quiero que los usuarios ingresen su correo y contraseña y reciban una validación inmediata, para evitar campos vacíos o datos incorrectos.   | Escenario 1: El usuario deja campos vacíos y el sistema muestra una alerta “Por favor ingrese su correo y contraseña.”<br>**Dado que** completo el formulario de cita, **Cuando** hago clic en "Confirmar", **Entonces** recibo una notificación visual de éxito.                                                               | EPIC05                  |
| HU20          | Visualizar planes disponibles    | Como desarrollador, quiero mostrar los distintos planes (Mini,Complete,vip) con nombre, descripción y botón “Comprar”, para facilitar elección.  | Escenario 1: El usuario accede y ve los tres planes diferenciados visualmente.<br>Escenario 2: Al hacer clic en “Comprar”, se registra la elección del plan. <br> **Dado que** dejo campos obligatorios vacíos, **Cuando** intento enviar, **Entonces** se muestra un mensaje de error en los campos correspondientes.                                                                                                                                         | EPIC02                  |
| HU21          | Gestión de mascotas              | Como desarrollador, quiero permitir que el usuario vea, agregue, elimine y seleccione mascotas en tarjetas, para que gestione fácilmente su información.          | Escenario 1: Se muestran las tarjetas con nombre y edad de cada mascota.<br> **Dado que** no recuerdo mi contraseña, **Cuando** uso la opción “Olvidé mi contraseña”, **Entonces** recibo instrucciones por correo.                                                                                                                   | EPIC04                  |
| HU22          | Agregar nueva mascota            | Como desarrollador, quiero que el usuario pueda ingresar nombre y edad en un formulario sencillo, para registrar fácilmente a su mascota.                        | Escenario 1: El usuario accede al formulario desde el menú “Agregar Mascota”.<br> **Dado que** tengo una cita agendada, **Cuando** hago clic en “Cancelar”, **Entonces** se elimina la cita y se muestra un mensaje de confirmación.                                                                                                                          | EPIC04                  |
| HU23          | Compra de medicamentos           | Como desarrollador, quiero mostrar medicamentos con nombre, descripción, selector de cantidad y botón “Comprar”, para que el usuario adquiera lo necesario.       | Escenario 1: El usuario accede a la pestaña “Medicamentos” y ve vacunas, desparasitantes y antibióticos.<br>**Dado que** accedo a mi perfil, **Cuando** hago clic en “Historial”, **Entonces** veo una lista cronológica de mis servicios anteriores.                                                                       | EPIC01                  |
| HU24          | Validación de campos vacíos en compra | Como desarrollador, quiero validar que el usuario seleccione al menos una unidad de medicamento antes de hacer clic en “Comprar”, para evitar errores de compra. | Escenario 1: Si no hay unidades seleccionadas, el sistema muestra un mensaje de error.<br> **Dado que** estoy en mi perfil, **Cuando** hago clic en “Editar”, **Entonces** puedo actualizar mis datos y guardar los cambios correctamente.	.                                                                                                  | EPIC01                  |
| HU25          | Historial de tratamientos        | Como desarrollador, quiero mostrar en una tabla el historial de productos aplicados a cada mascota, para que el usuario tenga trazabilidad de los tratamientos.   | Escenario 1: El usuario accede al historial y ve una tabla con columnas: ID, Nombre (usuario), Mascota, Producto, Descripción.<br> **Dado que** estoy autenticado, **Cuando** hago clic en “Cerrar sesión”, **Entonces** mi sesión se cierra y soy redirigido al login.                                                                                        | EPIC04                  |
| HU26          |  Mostrar historial  | Como desarrollador, quiero permitir filtrar el historial por mascota, para que el usuario visualice solo los registros relevantes.                               | Escenario 1: El usuario selecciona una mascota de una lista desplegable y ve solo sus tratamientos.<br>**Dado que** he iniciado sesión correctamente, **Cuando** veo la barra de navegación, **Entonces** se muestra mi nombre en la esquina superior derecha.                                                                                                           | EPIC04                  |
